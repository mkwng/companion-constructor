			...
			layers: [
				{
					path: {
						...
						3: "pose3/11-shoes/hightops_1-v_clothing.png",
					},
					colorType: "clothing",
				},
				{
					path: {
						...
						3: "pose3/11-shoes/hightops_2-c_shadow.png",
					},
				...
				},
				{
					path: {
						...
						3: "pose3/11-shoes/hightops_4-c_outline.png",
					},
				...
				},
				{
					path: {
						...
						3: "pose3/11-shoes/hightops_3-c_white.png",
					},
			...
			layers: [
				{
					path: {
						...
						3: "pose3/11-shoes/rollerblades_1-v_clothing.png",
					},
					colorType: "clothing",
				},
				{
					path: {
						...
						3: "pose3/11-shoes/rollerblades_2-v_clothing.png",
					},
					colorType: "clothing",
				},
				{
					path: {
						...
						3: "pose3/11-shoes/rollerblades_3-c_shadow.png",
					},
					color: colors.default.gray,
					blendMode: "multiply",
				},
				{
					path: {
						...
						3: "pose3/11-shoes/rollerblades_4-c_outline.png",
					},
					color: colors.default.black,
				},
			],
			...
			layers: [
				{
					path: {
						...
						3: "pose3/11-shoes/sneaks_1-v_clothing.png",
					},
					colorType: "clothing",
				},
				{
					path: {
						...
						3: "pose3/11-shoes/sneaks_2-c_shadow.png",
					},
					color: colors.default.gray,
					blendMode: "multiply",
				},
				{
					path: {
						...
						3: "pose3/11-shoes/sneaks_3-c_outline.png",
					},
					color: colors.default.black,
				},
			],
